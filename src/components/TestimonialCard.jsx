...
export default function TestimonialCard({ testimonial }) {
  ...
  const meta = typeMeta[type] ?? { color: 'text-secondary', bg: 'bg-secondary/10', border: 'border-secondary/20' }

  return (
    <article className="group relative flex flex-col overflow-hidden bg-white shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500">

      {/* Bold left gold border */}
      <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-secondary/30 via-secondary to-secondary/30 z-10" />

      {/* Main body */}
      <div className="pl-7 pr-6 pt-7 pb-6 flex flex-col flex-1 gap-5">
      ...
      {/* Footer strip */}
      <div className="pl-7 pr-6 py-4 bg-[#F5F1EC] border-t border-[#E8DDD0] flex items-center gap-3">
